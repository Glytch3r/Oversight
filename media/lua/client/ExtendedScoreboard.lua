...
ExtendedScoreboard.fieldOrder = {
    Identity = {"Profession", "Access Level", "Display Name","Forename","Surname","Gender","Weight","Steam ID",},
    ...
    Movement = {"Coordinates","Safehouse","Sneaking","Moving","Performing Action","Running Time","Just Moved","Can't Sprint","Looking In Vehicle"},
}

ExtendedScoreboard.fieldMapping = {
    Identity = {"profession","accessLevel", "displayName","Forname","Surname","Gender","Weight","steamID",},
    ...
    Movement = {"Coordinates","isInSafehouse","IsSneaking","m_isPlayerMoving","m_isPerformingAnAction","runningTime","JustMoved","MoodleCantSprint","bLookingWhileInVehicle"},
}
...
function ExtendedScoreboard.liveUpdateTick()
    ...
    local isFast = not SandboxVars.Oversight.ScoreboardSlowerRefresh
