...
function Oversight.ClearLearned()
    local pl = getPlayer() 
...
function Oversight.ClearTraits()
    local pl = getPlayer() 
...
function Oversight.ClearFloorItems()
    local count = 0
    local rad = SandboxVars.Oversight.ClearRadius or 15
    local pl = getPlayer()
...
function Oversight.ClearFloorItems2()
    local pl = getPlayer() 
    local itemBuffer = {}
    local rad = SandboxVars.Oversight.ClearRadius or 15
...
function Oversight.ClearWornItems()
    local pl = getPlayer() 
    local plNum = pl:getPlayerNum() 
    pl:clearWornItems();
...
function Oversight.DespawnBodies()
    local count = 0
    local rad = SandboxVars.Oversight.ClearRadius or 15
    local pl = getPlayer()
    local cell = pl:getCell()
...
function Oversight.DespawnCars()
    local count = 0
    local rad = SandboxVars.Oversight.ClearRadius or 15
    local pl = getPlayer()
    local cell = pl:getCell()
...
function Oversight.DespawnPlants()
    local pl = getPlayer() 
    local x, y, z = pl:getX(), pl:getY(), pl:getZ()
    local rad = SandboxVars.Oversight.ClearRadius or 15
    for xx = -rad, rad do
...
function Oversight.clearWeather()
    if isClient() then
